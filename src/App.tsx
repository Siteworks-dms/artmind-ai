  ...
  return (
    <div style={{ paddingTop: 'var(--nav-h)' }}>
      <section style={{
        ...
        {[
          {s:500,t:-100,l:-150,c:'#a78bfa'},
          {s:400,t:'40%',r:-120,c:'#ec4899'},
          {s:350,b:-80,l:'30%',c:'#f59e0b'},
        ].map((o,i) => (
          <div key={i} style={{
      ...
      <section style={{padding:'72px 24px',textAlign:'center'}}>
        <h2 style={{fontFamily:'var(--font-display)',fontSize:'clamp(1.8rem,4vw,2.8rem)',fontWeight:800,marginBottom:14}}>
